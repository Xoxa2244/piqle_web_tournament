        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;">
          <tr>
            <td align="center" style="padding-bottom:20px;">
              <img src="${logoUrl}" alt="IQSport" width="148" style="display:block;width:148px;max-width:100%;height:auto;border:0;outline:none;" />
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="padding:28px 28px 12px;text-align:center;">
                    ...
                    ${opts.subheading ? `<p style="margin:12px auto 0;max-width:520px;font-size:15px;line-height:1.75;color:#94A3B8;">${opts.subheading}</p>` : ''}
                  </td>
                </tr>
                <tr>
