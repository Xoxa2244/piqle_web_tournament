    ...
    .query(async ({ ctx, input }) => {
      ...
      return visibleClubs.map((club) => {
        ...
        return {
          ...
          cityEn: club.cityEn,
          state: club.state,
          stateEn: club.stateEn,
          country: club.country,
          countryEn: club.countryEn,
        ...
        select: {
          ...
          announcements: {
            ...
            select: {
              ...
              locationTitleCustom: true,
              locationTitleEn: true,
              locationAddressEn: true,
              locationCityEn: true,
              locationStateEn: true,
              locationCountryEn: true,
  ...
  createAnnouncement: protectedProcedure
    .input(
      z.object({
        ...
        locationTitleCustom: z.string().max(200).nullable().optional(),
        locationTitleEn: z.string().max(200).nullable().optional(),
        locationAddressEn: z.string().max(400).nullable().optional(),
        locationCityEn: z.string().max(120).nullable().optional(),
        locationStateEn: z.string().max(120).nullable().optional(),
        locationCountryEn: z.string().max(120).nullable().optional(),
        locationPlaceId: z.string().max(255).nullable().optional(),
        locationProvider: z.string().max(80).nullable().optional(),
      ...
      const announcement = await ctx.prisma.$transaction(async (tx) => {
        const created = await tx.clubAnnouncement.create({
          data: {
            ...
            locationTitleCustom: input.locationTitleCustom?.trim() || input.locationTitle?.trim() || null,
            locationTitleEn: input.locationTitleEn?.trim() || input.locationTitle?.trim() || null,
            locationAddressEn: input.locationAddressEn?.trim() || input.locationAddress?.trim() || null,
            locationCityEn: input.locationCityEn?.trim() || null,
            locationStateEn: input.locationStateEn?.trim() || null,
            locationCountryEn: input.locationCountryEn?.trim() || null,
            locationPlaceId: input.locationPlaceId?.trim() || null,
            locationProvider: input.locationProvider?.trim() || null,
      ...
      const updated = await ctx.prisma.$transaction(async (tx) => {
        const result = await tx.clubAnnouncement.update({
          ...
          data: {
            ...
            locationTitleCustom:
              input.removeLocation ? null : input.locationTitleCustom?.trim() || input.locationTitle?.trim() || null,
            locationTitleEn:
              input.removeLocation ? null : input.locationTitleEn?.trim() || input.locationTitle?.trim() || null,
            locationAddressEn:
              input.removeLocation ? null : input.locationAddressEn?.trim() || input.locationAddress?.trim() || null,
            locationCityEn: input.removeLocation ? null : input.locationCityEn?.trim() || null,
            locationStateEn: input.removeLocation ? null : input.locationStateEn?.trim() || null,
            locationCountryEn: input.removeLocation ? null : input.locationCountryEn?.trim() || null,
            locationPlaceId: input.removeLocation ? null : input.locationPlaceId?.trim() || null,
            locationProvider: input.removeLocation ? null : input.locationProvider?.trim() || null,
