    ...
    .mutation(async ({ ctx, input }) => {
      ...
      switch (currentStage) {
        case 'RR_IN_PROGRESS':
          ...
          // For Round Robin tournaments, winners are determined by standings - no play-in or play-off
          if (isRoundRobin) {
            // Round Robin: tournament is complete after Round Robin, winners determined by standings
            matchesToCreate = []
