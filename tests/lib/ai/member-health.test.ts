...
describe('Здоровье участников > Валидация границ', () => {
  ...
  it('сумма весов компонентов = 100', () => {
    ...
    const totalWeight = c.frequencyTrend.weight + c.recency.weight + c.consistency.weight + c.patternBreak.weight + c.noShowTrend.weight + c.cancelAcceleration.weight + c.sessionDiversity.weight + c.coPlayerLoss.weight
