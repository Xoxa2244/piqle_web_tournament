          ...
          <div className="hidden sm:flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="pl-3 pr-7 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-0"
              >
          ...
          <div className="sm:hidden py-4 space-y-3">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <select
                value={selectedDivisionId}
                onChange={(e) => setSelectedDivisionId(e.target.value)}
                className="pl-3 pr-7 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-center min-w-0 flex-1"
              >
                {(tournament.divisions as any[]).map((division: any) => (
                  <option key={division.id} value={division.id}>
                    {division.name}
