...
export default function IntelligenceDashboardPage() {
  ...
  if (brand.key === 'iqsport') {
    ...
    return <DashboardIQ dashboardData={data || undefined} healthData={healthData || undefined} heatmapData={heatmapData || undefined} memberGrowthData={memberGrowthData || undefined} uploadHistoryData={uploadHistoryData || undefined} settingsData={settingsData || undefined} isLoading={isLoading || !!error} clubId={clubId} isDemo={isDemo} />
  }
