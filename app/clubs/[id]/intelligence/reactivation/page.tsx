...
import { useReactivationCandidates, useSendReactivation, useChurnTrend, useCampaignList, useMemberAiProfiles } from '../_hooks/use-intelligence'
...
export default function ReactivationPage() {
  ...
  if (brand.key === 'iqsport') return <ReactivationIQ reactivationData={data} churnTrendData={churnTrendData} campaignListData={campaignListData} isLoading={isLoading} error={error} sendReactivation={sendReactivation} clubId={clubId} aiProfiles={aiProfilesMap} />
