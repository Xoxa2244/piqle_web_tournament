...
// ── Mock AI responses for IQ demo (English-only) ──

type MockEntry = { keywords: string[]; en: string }
...
const mockResponses: MockEntry[] = [
  ...
  { keywords: ['risk', 'churn', 'at risk', 'churning'],
  ...
  { keywords: ['occupancy', 'tuesday', 'morning', 'fill'],
