...
[Your name]`}
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  <Trophy className="w-5 h-5" />
                  <CardTitle>7. Submit Game Results via API (NEW)</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-700">
                  In addition to entering results through the Piqle web interface, the partner can now submit individual game scores 
                  directly via API. This is designed for scenarios where team captains on the partner side enter results for their own games.
                </p>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-3">How it works:</h4>
                  <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>Each matchup has 12 games (order 1–12), generated by the tournament director when the match is ready to start</li>
                    <li>When games are generated, a <code className="bg-gray-100 px-1 py-0.5 rounded">schedule.updated</code> webhook is sent — fetch <code className="bg-gray-100 px-1 py-0.5 rounded">/schedule</code> to see the games with their <code className="bg-gray-100 px-1 py-0.5 rounded">gameOrder</code>, <code className="bg-gray-100 px-1 py-0.5 rounded">homePair</code>, and <code className="bg-gray-100 px-1 py-0.5 rounded">awayPair</code></li>
                    <li>The partner identifies the matchup by <code className="bg-gray-100 px-1 py-0.5 rounded">externalMatchupId</code> and each game by <code className="bg-gray-100 px-1 py-0.5 rounded">gameOrder</code> (1–12)</li>
                    <li>Captain knows their letter (A/B/C/D) and can find their games by looking at <code className="bg-gray-100 px-1 py-0.5 rounded">homePair</code>/<code className="bg-gray-100 px-1 py-0.5 rounded">awayPair</code></li>
                    <li>Captain submits <code className="bg-gray-100 px-1 py-0.5 rounded">homeScore</code> and <code className="bg-gray-100 px-1 py-0.5 rounded">awayScore</code> for one or more games at a time</li>
                    <li>System recalculates <code className="bg-gray-100 px-1 py-0.5 rounded">gamesWonHome</code> / <code className="bg-gray-100 px-1 py-0.5 rounded">gamesWonAway</code> automatically</li>
                    <li>If the score is 6-6, the partner must also submit <code className="bg-gray-100 px-1 py-0.5 rounded">tieBreakWinnerSide</code> (&quot;home&quot; or &quot;away&quot;)</li>
                  </ol>
                </div>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-900 mb-2">Important:</h4>
                  <ul className="list-disc list-inside space-y-1 text-blue-800">
                    <li>Tied scores (e.g., 11-11) are not allowed and will be rejected</li>
                    <li>Results cannot be submitted for completed matchups (status = COMPLETED)</li>
                    <li>Matchup status is NOT automatically set to COMPLETED — the tournament director must manually finalize it</li>
                    <li>When the first game result is submitted, matchup status changes from PENDING to IN_PROGRESS</li>
                  </ul>
                </div>
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800">
                    ...
                    — see the API Endpoints tab for full request/response details.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle>8. Update Data from Partner Side</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-700">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle>9. Get Results</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-700">
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="bg-white rounded-lg p-4 border border-blue-200">
                    ...
                    <ol className="list-decimal list-inside space-y-2">
                      ...
                      <li>Tournament director assigns letters to players via web interface</li>
                      <li>Game results are entered via API by team captains (POST /results/submit) or manually by the tournament director in the web interface</li>
                      <li>Tournament director marks matchups as COMPLETED when all results are finalized</li>
                      <li>Partner retrieves aggregated results via API</li>
            ...
            <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-2">
                    <Badge variant="default" className="bg-green-600">POST</Badge>
                    <CardTitle className="mb-0">Submit Game Results (NEW)</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-gray-700">
                    Submits individual game scores for a matchup. The partner identifies the matchup by <code className="bg-gray-100 px-2 py-1 rounded">externalMatchupId</code> and 
                    each game by its <code className="bg-gray-100 px-2 py-1 rounded">gameOrder</code> (1–12). You can submit one or more games per request.
                    The system recalculates <code className="bg-gray-100 px-2 py-1 rounded">gamesWonHome</code> / <code className="bg-gray-100 px-2 py-1 rounded">gamesWonAway</code> automatically.
                    If the final score is 6-6, you must also provide <code className="bg-gray-100 px-2 py-1 rounded">tieBreakWinnerSide</code>.
                    Matchup status is NOT automatically set to COMPLETED — the tournament director finalizes it manually.
                  </p>
                  <div>
                  ...
                  <div>
                    <h3 className="font-semibold mb-2">Field Reference:</h3>
                    <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">externalMatchupId</code> (required) — your matchup ID from <code className="bg-gray-100 px-1 py-0.5 rounded">/matchups/upsert</code></li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">games</code> (required, 1–12 items) — array of game scores</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">games[].gameOrder</code> (required, 1–12) — game position in the matchup</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">games[].homeScore</code> (required, &gt;= 0) — home team score for this game</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">games[].awayScore</code> (required, &gt;= 0) — away team score for this game (must not equal homeScore)</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded">tieBreakWinnerSide</code> (optional, &quot;home&quot; | &quot;away&quot;) — required when total gamesWon is 6-6</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="font-semibold mb-2">Response (200):</h3>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <h4 className="font-semibold text-yellow-900 mb-2">Error Codes Specific to This Endpoint:</h4>
                    <ul className="list-disc list-inside space-y-1 text-yellow-800 text-sm">
                      <li><code className="bg-yellow-100 px-1 py-0.5 rounded">MATCHUP_NOT_FOUND</code> — matchup with the given externalMatchupId not found</li>
                      <li><code className="bg-yellow-100 px-1 py-0.5 rounded">MATCHUP_COMPLETED</code> — cannot update results for a completed matchup</li>
                      <li><code className="bg-yellow-100 px-1 py-0.5 rounded">GAMES_NOT_GENERATED</code> — games have not been generated yet (assign rosters and letters first)</li>
                    </ul>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-700">
                    Returns the full tournament schedule for IndyLeague: match days, matchups, divisions, teams, courts, and games.
                    Each matchup includes a <code className="bg-gray-100 px-1 py-0.5 rounded">gamesGenerated</code> flag and a <code className="bg-gray-100 px-1 py-0.5 rounded">games</code> array.
                    When games are generated, the array contains all 12 games with <code className="bg-gray-100 px-1 py-0.5 rounded">gameOrder</code>, <code className="bg-gray-100 px-1 py-0.5 rounded">homePair</code>, <code className="bg-gray-100 px-1 py-0.5 rounded">awayPair</code>, and current scores.
                    Use this data to determine which <code className="bg-gray-100 px-1 py-0.5 rounded">gameOrder</code> to submit results for via <code className="bg-gray-100 px-1 py-0.5 rounded">POST /results/submit</code>.
                  </p>
                  <div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h4 className="font-semibold text-blue-900 mb-2">Rosters &amp; Game Pairs:</h4>
                    <p className="text-blue-800 text-sm mb-2">
                      Each matchup includes <code className="bg-blue-100 px-1 py-0.5 rounded">homeRoster</code> and <code className="bg-blue-100 px-1 py-0.5 rounded">awayRoster</code> — 
                      arrays of 4 active players with their assigned letter (A/B/C/D), <code className="bg-blue-100 px-1 py-0.5 rounded">externalPlayerId</code>, and name.
                      The <code className="bg-blue-100 px-1 py-0.5 rounded">homePair</code>/<code className="bg-blue-100 px-1 py-0.5 rounded">awayPair</code> fields in each game reference these letters.
                      For example, <code className="bg-blue-100 px-1 py-0.5 rounded">homePair: &quot;AB&quot;</code> means players with letters A and B from the home team roster.
                    </p>
                    <p className="text-blue-800 text-sm">
                      <strong>Notification:</strong> When games are generated, a <code className="bg-blue-100 px-1 py-0.5 rounded">schedule.updated</code> webhook is sent.
                      Fetch <code className="bg-blue-100 px-1 py-0.5 rounded">/schedule</code> after receiving it to see rosters, games, and pairs.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li><code className="bg-gray-100 px-2 py-1 rounded">MATCHUP_NOT_FOUND</code> - Matchup with external ID not found</li>
                    <li><code className="bg-gray-100 px-2 py-1 rounded">MATCHUP_COMPLETED</code> - Cannot modify a completed matchup</li>
                    <li><code className="bg-gray-100 px-2 py-1 rounded">GAMES_NOT_GENERATED</code> - Games not yet generated for this matchup</li>
