      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm text-gray-500">
            <div>Start: {formatUsDateTimeShort(tournament.startDate, { timeZone: (tournament as any).timezone })}</div>
            <div>End: {formatUsDateTimeShort(tournament.endDate, { timeZone: (tournament as any).timezone })}</div>
