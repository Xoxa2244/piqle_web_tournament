const APP_SCHEME = 'piqle://profile/edit?stripe=return'

export default function StripeMobileCompatPage() {
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#0b0b0b', color: '#fff' }}>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `setTimeout(function(){ window.location.href = ${JSON.stringify(APP_SCHEME)}; }, 120);`,
        }}
      />
    </main>
  )
